                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group form-group-lg field_select">
                                    <label class="sr-only"><?php _che(${'options_name_79'}); ?></label>
                                    <select id="search_option_79<?php echo $direction;?>" class="form-control select_styled base no-padding">
            <?php _che(${'options_values_79'}); ?>
        </select>
                                </div>
                            </div>
                            <div class="col-md-2">
