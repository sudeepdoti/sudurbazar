...
(function ($) {
  ...
  // imagesPath - returns the path to the images folder
  function imagesPath() {
    //return "http://localhost/property-point/templates/deta-prut/";
  ...
  function refresh(editor) {
    ...
    doc.write(
      options.docType +
      '<html>' +
      ((options.docCSSFile === '') ? '' : '<head><base href="'+options.baseHref+'"><link rel="stylesheet" type="text/css" href="' + options.docCSSFile + '" /></head>') +
