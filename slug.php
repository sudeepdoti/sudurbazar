...
$script_folder = '/themes-customization/';
...
$sql_profile = "SELECT * FROM user WHERE username='".$_GET['uri']."';";
...
if($dot_pos !== false)
{
    ...
    $sql_profile = "SELECT * FROM user WHERE username='".$_GET['uri']."' OR username='".$dot_profile."';";
}
