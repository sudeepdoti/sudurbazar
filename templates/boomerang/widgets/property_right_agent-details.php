...
<div id="agents-block" class="section-title-wr pg-opt" style="padding-bottom: 15px;">
    <h3 class="section-title left"><span><?php _l('Seller Details');?></span></h3>
</div>
<div class="panel">
    <div class="wp-block testimonial style-1 base right-agents">
        <div class="testimonial-author light">  
            ...
            <div class="author-info">
                ...
                <small class="author-pos">Phone: <a href="tel:<?php  echo _che(_ch($agent_phone)); ?>"><?php  echo _che(_ch($agent_phone)); ?></a></small>
